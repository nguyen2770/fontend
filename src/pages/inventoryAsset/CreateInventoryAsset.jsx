...
export default function CreateInventoryAsset() {
    ...
    useEffect(() => {
        setHeaderTitle("Thêm mới lịch kiểm kê");
        fetchAllDepartments();
    }, []);
    ...
    const onFinish = async (values) => {
        ...
        let res = await _unitOfWork.inventoryAsset.createInventoryAsset(payload);
        if (res && res.code === 1) {
            navigate(-1);
        }
    };
                ...
                <Card
                    ...
                    extra={
                        <>
                            ...
                            <Button className="bt-green" type="primary" onClick={() => {
                                form.setFieldsValue({
                                    isConfirm: true
                                })
                                form.submit();
