  ...
  useEffect(() => {
    if (assetModelChange) {
      form.setFieldsValue({
        ...
        category:
          assetModelChange?.category?.id || assetModelChange?.category?._id,
        subCategory:
          assetModelChange?.subCategory?.id ||
          assetModelChange?.subCategory?._id,
        supplier:
          assetModelChange?.supplier?.id || assetModelChange?.supplier?._id,
      });
    }
          ...
          <Row gutter={32}>
            ...
            <div className="modal-footer">
              ...
              <Button type="primary" htmlType="submit">
                <PlusCircleOutlined /> {t("assetModel.common.buttons.update")}
              </Button>
            </div>
          </Row>
        </Card>
